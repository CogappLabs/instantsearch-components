...
URL to a tag such as `@v0.5.0`: jsDelivr caches a tag for good, so a pinned
...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/gh/CogappLabs/instantsearch-components@v0.5.0/cdn/instantsearch-components.css"
/>
...
<script src="https://cdn.jsdelivr.net/gh/CogappLabs/instantsearch-components@v0.5.0/cdn/instantsearch-js.min.js"></script>
...
boolean checkbox the same way. `container` takes an element or a selector, and every other option is a
...
<script src="https://cdn.jsdelivr.net/npm/@searchkit/instantsearch-client@4"></script>
<script src="https://cdn.jsdelivr.net/gh/CogappLabs/instantsearch-components@v0.5.0/cdn/react-instantsearch.min.js"></script>
...
<script type="module">
  ...
  await import(
    "https://cdn.jsdelivr.net/gh/CogappLabs/instantsearch-components@v0.5.0/cdn/react-instantsearch.min.js"
  );
